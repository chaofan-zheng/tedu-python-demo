...
- 说明:
    - protocol（协议）
        - **http** 通过 HTTP 访问该资源。 格式 `HTTP://`
          ...
          明文传输，早起的展示性的、宣传性的网站，无需加密。
        
- **https** 通过安全的 HTTPS 访问该资源。 格式 `HTTPS://`
        
          加密传输，适用于更多的业务，特别是由资金往来的业务。
...
- 练习:
    ...
    - 通过这个案例，我们得知：
        ...
        **两个url可以对应同一个视图函数；path/re_path转换器传参时是关键字传参，与位置无关。**
...
Host: 127.0.0.1:8000         -> headers  请求头
...
- HTTP1.1 请求详述
    ...
    | 7 | OPTIONS | 允许客户端查看服务器的性能。**协商请求**，**项目时，细讲。** |
